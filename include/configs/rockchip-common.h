...
#define RKIMG_DET_BOOTDEV \
	...
	"elif nvme dev 0 && rkimgtest nvme 0; then " \
		"setenv devtype nvme; setenv devnum 0; echo Boot from nvme 0;" \
	"elif scsi dev 0 && rkimgtest scsi 0; then " \
		"setenv devtype scsi; setenv devnum 0; echo Boot from scsi 0;" \
